"""kedro-dynamic-pipeline-hook-example file for ensuring the package is executable
as `kedro-dynamic-pipeline-hook-example` and `python -m kedro_dynamic_pipeline_hook_example`
"""
import importlib
