...
# kedro_dynamic_pipeline_hook_example documentation build
...
from kedro_dynamic_pipeline_hook_example import __version__ as release

# -- Project information -----------------------------------------------------

project = "kedro_dynamic_pipeline_hook_example"
author = "Kedro"
...
htmlhelp_basename = "kedro_dynamic_pipeline_hook_exampledoc"
...
latex_documents = [
    (
        master_doc,
        "kedro_dynamic_pipeline_hook_example.tex",
        "kedro_dynamic_pipeline_hook_example Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "kedro_dynamic_pipeline_hook_example",
        "Project kedro_dynamic_pipeline_hook_example codebase.",
        "Nearest-Neighbour",
    )
]
